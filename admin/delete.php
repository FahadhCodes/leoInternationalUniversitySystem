      ...
      <div class="formContainer">
        ...
        if (isset($_POST['cb-1'])) {
          ...
          try {
            ...
            echo "<script>alert('A FACULTY REMOVED')</script>";
          } catch (mysqli_sql_exception $e) {
            echo "<script>alert('YOU CAN NOT DELETE A FACULTY THAT STUDENTS ARE STUDYING')</script>";
          }
        }
        ?>
        <!--------------------------------------------------------------------------DEPARTMENT----------------------------------------------------------------------->
        ...
        if (isset($_POST['cb-2'])) {
          ...
          try {
            ...
            mysqli_query($con, $deleteQuery);
            echo "<script>alert('A DEPARTMENT REMOVED')</script>";
          } catch (mysqli_sql_exception $e) {
            echo "<script>alert('YOU CAN NOT DELETE A DEPARTMENT THAT STUDENTS ARE STUDYING')</script>";
          }
        }
        ?>
        <!--------------------------------------------------------------------------SUBJECTS----------------------------------------------------------------------->
        ...
        if (isset($_POST['cb-3'])) {
          ...
          try {
            ...
            mysqli_query($con, $deleteQuery);
            echo "<script>alert('A SUBJECT REMOVED')</script>";
          } catch (mysqli_sql_exception $e) {
            echo "<script>alert('YOU CAN NOT DELETE A SUBJECT THAT STUDENTS ARE STUDYING')</script>";
          }
        }
        ?>
      </div>
        ...
        if (isset($_POST['submit-A'])) {
          ...
          try {
            ...
            if ($count > 0) {
              ...
              echo "<script>alert('A STUDENT REMOVED')</script>";
            } else {
              echo "<script>alert('There is no such student recode in database!')</script>";
            }
          } catch (mysqli_sql_exception $e) {
            echo "<script>alert('DELETE THE STUDENT ACCOUNT BEFORE REMOVE THEM')</script>";
          }
        }
        ?>
      </div>
      ...
      <div class="formContainer">
        ...
        if (isset($_POST['submit-B'])) {
          ...
          if ($count > 0) {
            ...
            mysqli_query($con, $deleteQuery);
            echo "<script>alert('A STAFF REMOVED')</script>";
          } else {
            echo "<script>alert('There is no such staff recode in database!')</script>";
          }
        }
        ?>
      </div>
